...
const StickerPeel: React.FC<StickerPeelProps> = ({
  ...
  useEffect(() => {
    ...
    const touchActiveClass = styles["touch-active"];

    const handleTouchStart = () => {
      container.classList.add(touchActiveClass);
    };

    const handleTouchEnd = () => {
      container.classList.remove(touchActiveClass);
    };
  ...
  return (
    ...
    >
      ...
      <div className={styles["sticker-container"]} ref={containerRef}>
        <div className={styles["sticker-main"]}>
          <div className={styles["sticker-lighting"]}>
            <img
              src={imageSrc}
              alt=""
        ...
        <div className={styles.flap}>
          <div className={styles["flap-lighting"]}>
            <img
              src={imageSrc}
              alt=""
              className={styles["flap-image"]}
              draggable="false"
              onContextMenu={(e) => e.preventDefault()}
            />
          </div>
